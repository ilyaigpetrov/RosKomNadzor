...
5. [FireFox Add-ons](https://addons.mozilla.org/ru/firefox/addon/обход-блокировок-рунета/) (заблочено Мозиллой для российских IP-адресов / blocked by Mozilla for IP-addresses in Russia). Для автономной установки (минуя магазин) см. https://github.com/anticensority/runet-censorship-bypass/releases.
